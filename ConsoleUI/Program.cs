    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
             ...
             */
            var CX5 = new Car() { HasTrunk = true, Make = "Mazda", Model = "CX5", Year = 2020 };
            var motorcycle = new Motorcycle() { HasSideCart = true, Make = "HD", Model = "Chopper", Year = 1978 };

            Vehicle sedan = new Car() { Make = "Dodge", Model = "Challenger", Year = 2020 };
            Vehicle sport = new Car() { HasTrunk = false, Make = "Rolls Royce", Model = "Sport" };
            /*
